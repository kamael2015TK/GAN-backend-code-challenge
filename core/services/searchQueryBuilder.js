...
const equal = (param, value) => validateSearch({
		param: param,
		match: SEARCH_OPERATIONS.EQUAL,
		value: value
});

const includes = (param, value) => validateSearch({
    param: param,
    match: SEARCH_OPERATIONS.INCLUDES,
    value: value
});

const contains = (param, value) => validateSearch({
    param: param,
    match: SEARCH_OPERATIONS.CONTAINS,
    value: value
});

const and = (params) => validateSearchList({
    match: SEARCH_OPERATIONS.AND,
    value: params
});

const or = (params) => validateSearchList({
